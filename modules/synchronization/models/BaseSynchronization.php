...
class BaseSynchronization extends Model {

    public static $onCrmAdd = 'onCrmCompanyAdd';
    public static $onCrmUpdate = 'onCrmCompanyUpdate';
    public static $onCrmDelete = 'onCrmCompanyDelete';
    public static $isSyncError = 'isCompanySyncError';
