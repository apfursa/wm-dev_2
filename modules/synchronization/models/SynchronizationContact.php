...
class SynchronizationContact extends Model {

    public static $onCrmAdd = 'onCrmContactAdd';
    public static $onCrmUpdate = 'onCrmContactUpdate';
    public static $onCrmDelete = 'onCrmContactDelete';
    public static $isSyncError = 'isContactSyncError';
